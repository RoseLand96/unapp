...
<title>Certificaciones</title>
 <link rel="shortcut icon" type="image/x-icon" href="img/certificacion.ico"/>
</head>
...
<p align="center"><img src="img/certificacion.ico" ></p>
<center>
...
while($row=$resultado->fetch_assoc())
{
   ...
   <th bgcolor="#DAF9ED"><a href="modificar_certificacion.php?id_documento=<?php echo $row['id_documento']; ?>" ><img src="img/editar.png" width="40" height="40"></a></th>
