...
<p align="center"><img src="img/estudiant.png" width="100" height="100"></p>
<h3 align="center">Insertar estudiantes</h3>
<p>
<form action="guardar_es.php" method="POST" enctype="multipart/form-data">
...
<h3 align="center">Operaciones con estudiantes</h3>
</form>
<p>
<center>
  <table class="responsive-table">
    <thead>
    <tr>
      <th bgcolor="#FEF2A7" colspan="8">Estudiantes</th>
    </tr>
      <tr>
...
while($row=$resultado->fetch_assoc())
{
  ...
  <td bgcolor="#DAF9ED"><?php echo $row['contrasena']; ?></td>
   <th bgcolor="#DAF9ED"><a href="modificar_es.php?matricula_es=<?php echo $row['matricula_es']; ?>" ><img src="img/editar.png" width="40" height="40"></a></th>
    <th bgcolor="#DAF9ED"><a  onclick="return confirm('¿estas seguro(a) que desea eliminar este producto?')" href="eliminar_es.php?matricula_es=<?php echo $row['matricula_es']; ?>" ><img src="img/borrar.png" width="50" height="50"></a></th>
   </tr>
  <?php
}
 ?>
