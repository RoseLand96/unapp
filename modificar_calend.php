...
$query="SELECT * from calendario where id_calendario='$id'";
$resultado=$conexion->query($query);
$row=$resultado->fetch_assoc();

   ?>
   <form action="proceso_modif_calend.php?id_calendario=<?php echo $row['id_calendario'];?>" method="POST" enctype="multipart/form-data">
