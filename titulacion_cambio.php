...
<title>Titulacion Cambio</title>
 <link rel="shortcut icon" type="image/x-icon" href="img/titulacion.ico"/>
</head>
...
while($row=$resultado->fetch_assoc())
{
   ...
   <th bgcolor="#DAF9ED"><a  onclick="return confirm('¿estas seguro(a) que desea eliminar este producto?')" href="modificar_titulacion.php?id_documento=<?php echo $row['id_documento']; ?>" ><img src="img/editar.png" width="40" height="40"></a></th>
