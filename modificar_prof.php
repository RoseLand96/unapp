...
$row=$resultado->fetch_assoc();
   ...
   ?>
   <form action="proceso_modif_prof.php?id_profesor=<?php echo $row['id_profesor'];?>" method="POST" enctype="multipart/form-data">
<center><table border="1">
  ...
  <tr bgcolor="skyblue">
    <td bgcolor="skyblue"><strong>Matricula:</strong></td><td><input type="text" REQUIRED name="mat" value="<?php echo $row['matricula_prof'];?>"></td>
